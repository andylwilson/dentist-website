...
$website = "andycodes.net Portal";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	...
	<div>	
		<label>
			Comments:<br /><textarea name="Comments" cols="50" rows="7" placeholder="Your comments are important to us!" tabindex="30"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
